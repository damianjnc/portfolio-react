...
const database = {
  information: {
    name: 'Damian Joniec',
    aboutContent: "I am a Frontend React developer. I can provide clean code and pixel perfect design. I also make website more & more interactive with web animations.",
    age: '',
    phone: '',
    nationality: '',
  ...
  services: [
    ...
    },
    {
      title: "Frameworks",
      icon: 'frame-expand',
      details: "React, Redux, React Hooks, Context API, ExpressJS, HapiJS, ​Jest, Enzyme, StoryBook"
    }
  ],
  reviews: [
    {
